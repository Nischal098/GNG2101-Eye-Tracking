...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->btnEmail->Size = System::Drawing::Size(417, 350);
			...
			this->btnTextToSpeech->Location = System::Drawing::Point(426, 3);
			this->btnTextToSpeech->Name = L"btnTextToSpeech";
			this->btnTextToSpeech->Size = System::Drawing::Size(417, 350);
			...
			this->btnSettings->Location = System::Drawing::Point(3, 359);
			this->btnSettings->Name = L"btnSettings";
			this->btnSettings->Size = System::Drawing::Size(417, 350);
			...
			this->btnQuit->Location = System::Drawing::Point(849, 359);
			this->btnQuit->Name = L"btnQuit";
			this->btnQuit->Size = System::Drawing::Size(417, 350);
			...
			this->btnRing->Location = System::Drawing::Point(849, 3);
			this->btnRing->Name = L"btnRing";
			this->btnRing->Size = System::Drawing::Size(417, 350);
			...
			this->txtTextToSpeech->Location = System::Drawing::Point(3, 178);
			this->txtTextToSpeech->Multiline = true;
			this->txtTextToSpeech->Name = L"txtTextToSpeech";
			this->txtTextToSpeech->Size = System::Drawing::Size(411, 169);
			...
			this->txtTextToSpeech->TextChanged += gcnew System::EventHandler(this, &MyForm::txtTextToSpeech_TextChanged);
			// 
			// lblTextToSpeech
			// 
			...
			this->lblTextToSpeech->Size = System::Drawing::Size(411, 175);
			this->lblTextToSpeech->TabIndex = 6;
			this->lblTextToSpeech->Text = L"Type text here in this box";
			this->lblTextToSpeech->Click += gcnew System::EventHandler(this, &MyForm::lblTextToSpeech_Click);
			// 
			// layoutMainForm
			// 
			...
			this->layoutMainForm->RowStyles->Add((gcnew System::Windows::Forms::RowStyle(System::Windows::Forms::SizeType::Percent, 50)));
			this->layoutMainForm->Size = System::Drawing::Size(1269, 712);
			this->layoutMainForm->TabIndex = 7;
			this->layoutMainForm->Paint += gcnew System::Windows::Forms::PaintEventHandler(this, &MyForm::layoutMainForm_Paint);
			// 
			...
			this->layoutNestedTextToSpeech->Location = System::Drawing::Point(426, 359);
			...
			this->layoutNestedTextToSpeech->RowStyles->Add((gcnew System::Windows::Forms::RowStyle(System::Windows::Forms::SizeType::Percent,
				50)));
			this->layoutNestedTextToSpeech->Size = System::Drawing::Size(417, 350);
			this->layoutNestedTextToSpeech->TabIndex = 8;
			this->layoutNestedTextToSpeech->Paint += gcnew System::Windows::Forms::PaintEventHandler(this, &MyForm::layoutNestedTextToSpeech_Paint);
			// 
			// MyForm
			// 
			...
			this->ClientSize = System::Drawing::Size(1269, 712);
...
private: System::Void txtTextToSpeech_TextChanged(System::Object^  sender, System::EventArgs^  e) {
}
private: System::Void lblTextToSpeech_Click(System::Object^  sender, System::EventArgs^  e) {
}
private: System::Void layoutMainForm_Paint(System::Object^  sender, System::Windows::Forms::PaintEventArgs^  e) {
}
private: System::Void layoutNestedTextToSpeech_Paint(System::Object^  sender, System::Windows::Forms::PaintEventArgs^  e) {
}
};
}
